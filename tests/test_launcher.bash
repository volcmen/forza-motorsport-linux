...
activate_preexisting_service() {
    write_fake_state active preexisting
...
set_up() {
    ...
    : > "$FAKE_LOG"
    write_fake_state inactive none
    printf '0\n' > "$FAKE_COUNTER"
...
read_state() { read -r state invocation < "$FAKE_STATE"; }
...
run_test() {
    ...
    FAKE_STOP_STATUS=0
    unset PAM_KWALLET5_LOGIN FORZA_SELF_SIGNAL
    set_up
